...
const SearchBar = (data) => {
  return (
    ...
    <div>
      <a href={pdfs.map(pdf => pdf.file)} class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700" target="_blank">
        <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-l-lg" 
        src={pdfs.map(pdf => pdf.image)} alt="Card Picture"/>
