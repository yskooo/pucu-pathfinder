  ...
  return (
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center">
            ...
            <p className="mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg lg:mx-10">Do you have a feature request or you want to feature your research study in this platform?</p>
           <button>
