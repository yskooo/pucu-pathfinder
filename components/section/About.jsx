...
import aboutFiles from '../../public/files-about.svg'
const About = () => {
  return (
    <section class="bg-white dark:bg-gray-900 py-20" id='about'>
        <div class="gap-8 items-center px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
            ...
            <div class="mt-4 md:mt-0">
                ...
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">What is PUCU Pathfinder?</h2>
