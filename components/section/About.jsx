    ...
    <section class="dark:bg-gray-900 py-20" id='about'>
        <div class="gap-8 items-center px-4 mx-auto max-w-screen-2xl xl:gap-6 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
            ...
            <div class="mt-4 md:mt-0">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">About <span className='bg-clip-text bg-gradient-to-r from-green-700 to-blue-900'>PUCU PATHFINDER</span></h2>
                <p class="mb-6 mx-auto text-base font-light text-gray-500 md:text-lg">
