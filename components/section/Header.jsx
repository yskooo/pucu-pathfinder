...
const Header = () => {
  return (
    <nav className="bg-white px-2 sm:px-4 py-2.5 w-full left-0 border-b border-gray-200">
  ...
  <div className="flex md:order-2">
    <Link href='/articles'>
      <button type="button" className="text-white hover:bg-teal-800 bg-emerald-500 focus:ring-4 focus:outline-none focus:ring-teal-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-teal-600 dark:hover:bg-teal-700 dark:focus:ring-teal-800">
    ...
    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
      <ul className="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        <li>
          <a href="#home" className="block py-2 pl-3 pr-4 text-white rounded md:bg-transparent md:text-teal-700 md:p-0 dark:text-white" aria-current="page">Home</a>
        </li>
        <li>
