...
const Banner = () => {
  return (
    <section class="bg-[url('/banner.svg')] max-w-full h-screen bg-cover bg-center m-auto pt-20" id='home'>
    <div class="py-8 px-4 mx-auto max-w-screen-2xl text-end lg:py-16 lg:px-12">
        <h1 class="mb-4 mx-auto text-4xl font-extrabold tracking-tight leading-none text-yellow-300 md:text-5xl lg:text-6xl max-w-screen-lg">
        ...
        <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <a href="#" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-emerald-700 hover:bg-primary-500 focus:ring-4 focus:ring-primary-500">
                Learn more
            </a>
